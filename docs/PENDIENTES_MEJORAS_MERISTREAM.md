...
- **Identidad TMDB manual:** el editor comprueba conflictos antes de asignar un ID, pide confirmación explícita para fusionar duplicados y también avisa cuando solo existe un registro canónico sin ficha visible. Pregunta por separado si debe regenerar título, sinopsis, artwork, géneros, año y rating desde TMDB. La identidad se sincroniza con las filas canónicas relacionadas.
