...
|---|---:|---|---|
| Cinecalidad | 10/10 directos, 10/10 manifiestos, 10/10 segmentos | `*.vimeos.zip` (principal); `hls1.goodstream.one` como alternativa | Ninguna en la muestra |
...
| TioAnime | 15 directos, 13 manifiestos/segmentos válidos | Mega/OK | Dos rutas Mega upstream fallaron (502/429); queda únicamente como fallback |
...
- La cartelera pública TMDB pagina las solicitudes: una petición de 60 ahora devuelve 58 animes únicos en vivo (TMDB entrega 20 por página) y no duplica IDs.
