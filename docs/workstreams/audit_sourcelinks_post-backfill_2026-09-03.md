...
**Fecha de ejecución:** `2026-09-03T06:59:52.579Z`  
**Proveedores auditados:** `tioplus.app`, `lamovie.org`, `cinecalidad.am`, `hianimes`, `hianimes.se`, `tioanime.com`, `latanime.org`  
**Total enlaces auditados:** `20196`  
...
| :--- | :--- | :--- |
| `canonical_page` | 7365 | Páginas de detalle oficiales del portal del proveedor |
| `canonical_embed` | 8838 | Embeds externos con ID permanente (Voe, Mega, Dood, etc.) |
...
| `unknown` | 3639 | URLs no reconocidas o malformadas |
...
- **Total enlaces:** 444
- **Páginas canónicas (`canonical_page`):** 96
...
- **Episodios con hermana canónica viva:** 96
- **Episodios sin ninguna fuente válida restante:** 69

### Proveedor: `lamovie.org`

- **Total enlaces:** 7077
- **Páginas canónicas (`canonical_page`):** 6901
...
- **Embeds canónicos (`canonical_embed`):** 0
- **Directos estables (`stable_direct`):** 0
- **Directos efímeros activos/no determinables (`active_ephemeral_direct`):** 0
- **Directos efímeros vencidos (`expired_ephemeral_direct`):** 0
- **URLs inválidas de catálogo (`invalid_catalog_page`):** 0
- **Fuentes que deben reconstruirse desde página canónica:** **0**
- **Episodios con hermana canónica viva:** 0
- **Episodios sin ninguna fuente válida restante:** 2169

### Proveedor: `hianimes.se`
...
- **Fuentes que deben reconstruirse desde página canónica:** **0**
- **Episodios con hermana canónica viva:** 0
- **Episodios sin ninguna fuente válida restante:** 132

### Proveedor: `tioanime.com`

- **Total enlaces:** 8066
- **Páginas canónicas (`canonical_page`):** 0
- **Embeds canónicos (`canonical_embed`):** 7004
- **Directos estables (`stable_direct`):** 0
- **Directos efímeros activos/no determinables (`active_ephemeral_direct`):** 0
- **Directos efímeros vencidos (`expired_ephemeral_direct`):** 0
- **URLs inválidas de catálogo (`invalid_catalog_page`):** 0
- **Fuentes que deben reconstruirse desde página canónica:** **0**
- **Episodios con hermana canónica viva:** 0
- **Episodios sin ninguna fuente válida restante:** 1053

### Proveedor: `latanime.org`

- **Total enlaces:** 1855
- **Páginas canónicas (`canonical_page`):** 0
- **Embeds canónicos (`canonical_embed`):** 1595
- **Directos estables (`stable_direct`):** 0
- **Directos efímeros activos/no determinables (`active_ephemeral_direct`):** 0
- **Directos efímeros vencidos (`expired_ephemeral_direct`):** 0
- **URLs inválidas de catálogo (`invalid_catalog_page`):** 0
- **Fuentes que deben reconstruirse desde página canónica:** **0**
- **Episodios con hermana canónica viva:** 0
- **Episodios sin ninguna fuente válida restante:** 242
...
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-1-p27sqc` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-2-icb3wy` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-3-enjf92` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-4-feye0n` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-5-zmzoz1` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-6-2np8e2` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-7-w7l7w6` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-8-plgpri` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-9-hjlm53` |
| `hianimes` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/my-status-as-an-assassin-obviously-exceeds-the-heros-episode-10-b6m01e` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-1-dgcx0p` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-2-cgjzo2` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-3-d71lfj` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-4-vqyben` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-5-5bi84x` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-6-cuggkf-145` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-7-i0di6h` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-8-h1odgw` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-9-10rrcg` |
| `hianimes.se` | `unknown` | `hianimes.se` | `https://hianimes.se/watch/2200-nen-neko-no-kuni-nippon-episode-10-v15o4p` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/kimetsu-no-yaiba-movie-1-mugenjouhen-akaza-sairai-1` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/tensei-shitara-slime-datta-ken-movie-2-soukai-no-namidahen-1` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/the-ribbon-hero-1` |
| `tioanime.com` | `unknown` | `tioanime.com` | `https://tioanime.com/ver/boku-no-hero-academia-i-am-a-hero-too-1` |
| `tioanime.com` | `unknown` | `tioanime.com` | `https://tioanime.com/ver/ansatsu-kyoushitsu-movie-minna-no-jikan-1` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/nige-jouzu-no-wakagimi-2nd-season-1` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/nige-jouzu-no-wakagimi-2nd-season-2` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/nige-jouzu-no-wakagimi-2nd-season-3` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/nige-jouzu-no-wakagimi-2nd-season-4` |
| `tioanime.com` | `canonical_embed` | `tioanime.com` | `https://tioanime.com/ver/nige-jouzu-no-wakagimi-2nd-season-5` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/kaguya-sama-love-is-war-stairway-to-adulthood-latino-episodio-1` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/kaguya-sama-love-is-war-stairway-to-adulthood-latino-episodio-2` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-1` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-2` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-3` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-4` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-5` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-6` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-7` |
| `latanime.org` | `canonical_embed` | `latanime.org` | `https://latanime.org/ver/star-wars-visions-la-jedi-numero-9-episodio-8` |
