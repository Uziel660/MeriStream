...
const REPORT_DIRS = [
  // Las ejecuciones lanzadas desde Admin reutilizan este directorio para que
  // el mismo bloque de identidad muestre su progreso en vivo.
  path.resolve("work/admin-operations"),
