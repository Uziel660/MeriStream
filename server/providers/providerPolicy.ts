...
export const PROVIDER_POLICIES: Record<string, ProviderPolicy> = {
  ...
  doramasia: {
    ...
    defaultRating: 7.8,
    contentKinds: ["movie", "series"],
    audioLanguages: ["ko", "zh", "th", "ja", "tl", "es"],
    subtitleLanguages: ["es"],
    discovery: "direct_api",
    resolver: "doramasia",
    hosts: ["doramasia.com"],
    fallbackProvider: "doramasflix",
    notes: "GraphQL público de Doramasgo; conserva locators canónicos y resuelve embedshortener/Primeload/Streamwish JIT. VOE, Filemoon y Mixdrop se descartan.",
  },
  tudorama: {
    id: "tudorama",
    role: "primary",
    ...
    defaultRating: 7.6,
    contentKinds: ["movie", "series"],
    audioLanguages: ["ko", "zh", "ja", "es"],
    subtitleLanguages: ["es"],
    discovery: "page",
    resolver: "tudorama",
    hosts: ["tudorama.com"],
    fallbackProvider: "doramasflix",
    notes: "WStream/WordPress: catálogo HTML paginado, episodios corvus_get_episodes y servidores corvus_get_servers JIT. No persiste wrappers ni URLs firmadas.",
  },
  tioplus: {
    id: "tioplus",
    role: "secondary",
    ...
    hosts: ["tioplus.app"],
    fallbackProvider: "vidsrc",
    notes: "Catálogo HTML completo de películas, series, doramas y anime. Conserva URLs canónicas, descarta TurboViPlay/TurboSPlayer por segmentos no audiovisuales y resuelve HLS acek/dramiyos JIT.",
  },
  tubepelis: {
    id: "tubepelis",
    role: "fallback",
