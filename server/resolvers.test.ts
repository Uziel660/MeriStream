...
import { EmbedResolvers, providerResolverRegistry, isSupportedServer } from "./resolvers";
...
describe("ProviderResolverRegistry & Capabilities", () => {
  ...
  it("identifies Vidara and TheTube as supported servers", () => {
    expect(isSupportedServer("https://vidara.to/e/j0AJObTrrYbfb")).toBe(true);
    expect(isSupportedServer("https://vidaraa.cc/e/abc1234")).toBe(true);
    expect(isSupportedServer("https://the.tube/e/xyz789")).toBe(true);
    expect(isSupportedServer("https://they.tube/e/xyz789")).toBe(true);
  });
});
