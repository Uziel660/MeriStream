...
export class TioAnimeAdapter extends BaseScraperAdapter {
  ...
  public extractMetadata(
    ...
    // Sin candidato plausible: queda undefined -> 0 en el retorno (desconocido)
  ...
  public async extractStream(
    ...
    if (videos.length === 0) {
      // Las importaciones antiguas pueden conservar la ficha /anime/<slug>.
      // Los servidores solo aparecen en /ver/<slug>-N; saltar al primer
      // episodio mantiene reproducibles esas filas sin un segundo paso manual.
