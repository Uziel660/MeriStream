...
export interface AppPreferences {
  ...
  /** Permite a un administrador mostrar IDs externos en las fichas públicas. */
  showIdentityDetails: boolean;
  /** Permite a un administrador ocultar/mostrar el botón de editar en las tarjetas. */
...
export function getAppPreferences(userId?: string | null): AppPreferences {
  ...
  try {
    ...
    return {
      ...
      showIdentityDetails: parsed.showIdentityDetails === true,
      showAdminEditButton: parsed.showAdminEditButton !== false,
      autoPlayNextEpisode: parsed.autoPlayNextEpisode !== false,
